...
if __name__ == '__main__':
    ...
    tensor_path = f'{project_path}/simulated_tensor/{N}_{T}_{K_star}_{data_seed}'
    quantile_model_path = f'{project_path}/simulated_quantile_model/{N}_{T}_{K_star}_{data_seed}/hidden_{args.hidden}_lr_{args.lr}_lag_{lag_order}_horizon_1'
    log_dir = f'{project_path}/simulated_mlp_model/{N}_{T}_{K_star}_{data_seed}/hidden_{args.hidden}_lr_{args.lr}_lag_{lag_order}_horizon_1/{tau}'
    ...
    agent.load_data(tensor_path, str(0), str(200), str(400), num_workers)
